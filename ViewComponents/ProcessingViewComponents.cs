...
namespace WebsiteBanHang.ViewComponents
{
    ...
    {
        private readonly ILogger<ProcessingViewComponent> _logger;
        private readonly ApplicationDbContext _context;

        public ProcessingViewComponent(ApplicationDbContext context, ILogger<ProcessingViewComponent> logger)
        {
            _context = context;
            _logger = logger;
        }
        ...
        {
            return GetOrdersByStatusAsync(page, searchName, "Đang xử lý");
        }
    }
}